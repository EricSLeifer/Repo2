...
#' coraab <- 1/2
#'
#' crit2x2(corAa, corAab, coraab, dig = 2, niter = 5)
#' # crit23A
#' # [1] -2.13
#'
#' # sig23A
...
#' coraab <- 0.4572905
#'
#' crit2x2(corAa, corAab, coraab, niter = 5)
#' # crit23A
#' # [1] -2.13
#'
#' # crit23A
...
crit2x2 <- function(corAa, corAab, coraab, dig = 2,
	alpha = 0.05,  niter = 100, rseed = 537265, abseps = 1e-05, tol = 1e-04){
...
#	1/3-1/3-1/3 procedure.
	...
	auxfcn13 <- function(z, tol = tol){
 		(1 - pmvnorm(lower=-Inf, upper= -c(qnorm(z), qnorm(z),
		qnorm(z)), mean=c(0,0,0),
